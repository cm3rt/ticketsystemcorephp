CREATE DATABASE IF NOT EXISTS `ticketsys` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ticketsys`;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `admin_payout_address` varchar(35) DEFAULT NULL,
  `admin_public_key` varchar(66) DEFAULT NULL,
  `admin_key_index` int(9) DEFAULT NULL,
...
DROP TABLE IF EXISTS `tickets_shipping_options`;
CREATE TABLE IF NOT EXISTS `tickets_shipping_options` (
  `ticket_id` int(11) NOT NULL,
  `shipping_option_id` int(11) NOT NULL,
  PRIMARY KEY (`ticket_id`,`shipping_option_id`),
  KEY `shipping_option_id` (`shipping_option_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `admin_feedbacks`;
