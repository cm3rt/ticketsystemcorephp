...
class App {
    ...
    private $routes = [
        ...
        'tickets' => ['index' => 'GET', 'build' => 'GET', 'create' => 'POST', 'edit' => 'GET', 'update' => 'POST',
            'destroyImage' => 'GET', 'destroy' => 'POST'],
        'listings' => ['index' => 'GET', 'ticket' => 'GET', 'ticketImage' => 'GET', 'admin' => 'GET'],
    ...
    private function dispatchToController($db) {
        ...
        if($this->isValidControllerAndAction($controllerName, $actionName)) {
            # convert controller from param (c=bla) to CamelCase TicketSystem\BlaController
            $controllerClassName = "TicketSystem\\" . mb_convert_case($controllerName, MB_CASE_TITLE, "UTF-8") . "Controller";
